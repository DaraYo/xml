...
public class Table {
    ...
    public void setRow(List<Table.Row> row) {
		this.row = row;
	}
    ...
    public static class Row {
        ...
        @XmlElement(required = true)
        protected List<Table.Row.Columns> columns;
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link Table.Row.Columns }
         * 
         * 
         */
        public List<Table.Row.Columns> getColumns() {
            if (columns == null) {
                columns = new ArrayList<Table.Row.Columns>();
            }
            return this.columns;
        }


        public void setColumns(List<Table.Row.Columns> columns) {
